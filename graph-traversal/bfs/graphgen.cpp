/*
 *ATTENTION: This was just a port of the original program ( graphgen.cpp ) 
 * created by Sam Kauffman - Univeristy of Virginia, for the OpenDwarf benchmark suite
 * whith minimal modification by Juan José Ropero Cerro - University of Valladolid, Spain.
 *
...
int main( int argc, char ** argv )
{
	...
	{
		cerr << "Use of program\n\
	./createbfs_rodinia <num nodes> <filename_bit>\n\
	Example of use ./createbfs_rodinia 1024 1K\n\
	This should generate a file at ../test/graph-traversal/bfs under the name graph1K.txt \n";
		exit( 1 );
	}
	...
	string PATH = "../test/graph-traversal/bfs/";
	string filename = PATH + "graph" + s + ".txt";
