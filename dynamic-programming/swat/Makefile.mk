...
bin_PROGRAMS += swat
bin_PROGRAMS += createswat_query
bin_PROGRAMS += createswat_sampledb
...
createswat_query_SOURCES = dynamic-programming/swat/createswat_query.c
createswat_sampledb_SOURCES = dynamic-programming/swat/createswat_sampledb.c
