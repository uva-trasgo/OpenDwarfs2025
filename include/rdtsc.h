...
#define CL_TARGET_OPENCL_VERSION 110//DEFINE VERSION DE OPENCL A USAR EN COMPILACION
...
printf("WARNING:\n\
    Kernels time and Total times may not add up correctly, due to timers only reporting last kernel's execution times\n \
    If this happens this is due to dwarf design.\n\n\
********************************************************************************\n");}
