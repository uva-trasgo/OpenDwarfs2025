...
createkmeans_SOURCES = dense-linear-algebra/kmeans/datagen.cpp
...
kmeans-exec-local:
	...
	cp $(top_srcdir)/dense-linear-algebra/kmeans/kmeans_opencl_kernel_opt_gpu.cl ${DESTDIR}${bindir} #out -> opt
