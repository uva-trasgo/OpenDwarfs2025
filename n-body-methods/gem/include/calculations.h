...
/* DEPRECATED BY APPLE SINCE 2021
#ifdef __APPLE__
...
float sample_grid (float, float, float, float *, int, int, int, float[6]);
...
// Inidicada como inline pero no definida que hace
...
//inline uchar big_endian (void);// Inidicada como inline pero no definida que hace
